            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    ...
                    <div class="background-oxford color-white p-2 mb-3">
                        <h5 class="mb-2">Edit Degree</h5>
                    </div>

                    <form method="post" action="{{route('degree.edit',['id'=>$degree->id])}}">
                        {{csrf_field()}}

                        <div class="form-group  row">
                            <label for="degree_name" class="col-sm-2 col-form-label col-form-label-sm">Name: <span class="req-red">*</span></label>
                            <div class="col-md-10">
