...
@section('content')
    ...
    <section class="font-1 py-3 mt-3">
        <div class="container">
            ...
            <div class="row justify-content-center" id="app">
                <div class="col-lg-3  background-11">
                    <div class="row font-1">
                        <div class="col text-center">
                            <a href="assets" data-lightbox="profile-pic">
                                <img class="img-thumbnail radius-primary mt-3" src="{{$profile->profile->profile_picture}}" width="150" height="150">
                            </a>
                            <div class="row justify-content-center">
                                <div class="mt-3 ">
                                    <form class="mt-2 row text-center"
                                          ref="form"
                                          method="post"
                                          action="{{route('alumni-directory.edit',['id'=>$profile->id])}}"
                                        ...
                                        <input class="inputfile"
                                               ...
                                               @change="submit" data-multiple-caption="{count} files selected"
                                               multiple="">
                                        <label class="btn btn-outline-primary btn-xs" for="file-1"><span>Update Picture</span></label>
                                    </form>
                            ...
                            <p class="mb-0 small"><strong>Lives in</strong> {{$profile->profile->dist_state.', '.$profile->profile->country->name}}</p>
                            <hr class="color-9">
                ...
                <div class="col-md-9 pl-lg-6">
                    <div class="row">
                        <div class="col-lg-8 mt-5 mt-lg-0">
                            <h4 class="color-black mb-2">Update Profile</h4>
                            <p class="color-3"></p>
                        </div>
                    </div>

                        <div class="tabs px-3 overflow-hidden">

                            <div class="nav-bar background-11 p-2 row">
                                ...
                                <div class="nav-bar-item  @if(session('personalInfo'))  active @endif">Personal and Professional Info</div>
                                @if($profile->userType->name !="student")
                                    <div class="nav-bar-item @if(session('wHelp'))  active @endif">Willing to help</div>
                                @endif
                                <a class="btn btn-outline-primary btn-xs ml-5 pt-1" href="{{route('alumni-directory.show',['id'=>$profile->id])}}">View profile</a>
                            </div>

                            <div class="tab-contents h-full">
                                <div class="tab-content @if(session('basicInfo')) active @elseif( (!session('personalInfo')) && (!session('basicInfo')) && (!session('wHelp')) ) active @endif">
                                    <form class="mt-5 row" method="post" action="{{route('alumni-directory.edit',['id'=>$profile->id])}}" enctype="multipart/form-data" files="true">
                                        {{csrf_field()}}
                                ...
                                <div class="tab-content @if(session('personalInfo'))  active @endif">
                                    <form method="post" action="{{route('alumni-directory.edit',['id'=>$profile->id])}}">
                                        {{csrf_field()}}
                                        ...
                                        <div class="row align-items-center text-center justify-content-center">
                                            ...
                                            <div class="row background-11 w-100 py-2 mt-2 rounded" v-for="(row,index) in works">
                                ...
                                <div class="tab-content @if(session('wHelp'))  active @endif">
                                    <form class="text-left" method="post" action="{{route('alumni-directory.edit',['id'=>$profile->id])}}">
                                        {{csrf_field()}}
