                    ...
                    <div class="col-md-10 offset-md-1">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-6">
                                        <h5 class="text-primary">Create a poll</h5><br/>
                            ...
                            <div class="card-block">
                                <form action="{{route('poll.store')}}" method="POST">
                                        ...
                                        <div class="col-6">
                                            <select class="form-control hv-cursor-pointer" name="session_id">
                                                ...
                                                @foreach($sessions as $session)
                                                    <option value="{{$session->id}}" @if(old('session_id')==$session->id ) selected @endif>
                                                        {{$session->name}}
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="form-group row  @if ($errors->has('max_checkable')) has-danger @endif">
                                        <label for="max_check" class="col-3 text-primary">Please choose the maximum selectable option<br/><span class="text-muted small">More than 1 will be considered as checkbox</span><span class="req-red ml-1">*</span></label>
                                        
                                        <div class="col-6">
                                            <select class="form-control hv-cursor-pointer" name ="max_checkable" id="max_check">
                                                    <option value="" disabled selected>Please select</option>
                                                @foreach([1,2,3,4,5] as $maxcheck)
                                                    <option value="{{$maxcheck}}"  @if(old('max_checkable')==$maxcheck ) selected @endif>{{$maxcheck}}</option>
                                                @endforeach    
                                            </select>
                                    ...
                                    <div class="form-group row   @if ($errors->has('title')) has-danger @endif">
                                        <label for="poll_question" class="col-3  col-form-label text-primary">Please enter the poll question <span class="req-red">*</span> </label>
                                        <div class="col-6">
                                            <input class="form-control" type="text" name="title" id="poll_question" value="{{ old('title')}}">
                                            @if ($errors->has('title'))
                                    ...
                                    <div  v-for="(row,index) in rows">
                                        ...
                                        <div class="form-group row  @if ($errors->has('option_name.*')) has-danger @endif">
                                            <label for="option" class="col-3 col-form-label text-muted text-primary" v-if="index<1">Plese enter the options <span class="req-red">*</span> </label>
