        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-12">
                    ...
                    <div class="mb-3">
                        <h5 class="mb-3">Create New Donation</h5>
                    </div>
                    <div class="background-10 p-4">

                        <form method="post" action="{{route('donations.store')}}" enctype="multipart/form-data" files="true">
                            {{csrf_field()}}
                        ...
                        @endif
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <textarea class="form-control editText"
                                              name="description"
                                              id="description"
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <textarea class="form-control"
                                              name="payment_info"
                                              id="payment_info"
                                              rows="4">{{old('payment_info') }}</textarea>
